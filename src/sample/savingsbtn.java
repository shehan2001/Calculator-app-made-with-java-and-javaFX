...
// third class-savings calculator

    public static void third_page() {
...
//creating a toolbar
        ...
        Label compound = new Label("savings calculator");
...
//.................................................................................................//
        ...
        calc.setOnAction(event -> {
            ...
            calc_saving(M_P,F_V, I_D, I_R, N_O_Y);
            if (no == 1) {
                F_V.setText(rn12);
                Answer.setText(rn12);
            } else if (no == 2) {
...
//second method used for the calcualtion
    ...
    public static void calc_saving(TextField M_P, TextField F_V, TextField I_D, TextField I_R, TextField N_O_Y) {
...
// if condition see see what textfield is empty and not, to what should be calculated and not
        ...
        if (!M_P.getText().equals("") && !I_D.getText().equals("") && !I_R.getText().equals("") && !N_O_Y.getText().equals("")) {
            ...
            //monthly  Payment
        } else if (!I_R.getText().equals("") && !I_D.getText().equals("") && !F_V.getText().equals("") && !N_O_Y.getText().equals("")) {
